...
const Tweet = ({ tweet, showTime, showMetrics, showSource, showImage }) => {
  ...
  const modRetweets =
    retweets >= 1000 ? `${(retweets / 1000).toPrecision(2)}k` : retweets;
      ...
      <div className="tweet">
        ...
        <div className="time_source sec">
          <Text fontSize={font_size_small}>
            <span>
              {showTime && date && format(date, "h:mm a · LLL d, yyyy · ")}
            </span>
        ...
        {showMetrics && (
          <div className="metrics">
            <Text fontSize={font_size_small}>
              ...
              <span className="sec likes"> Likes</span>{" "}
              <span className="bold">{modRetweets}</span>{" "}
              <span className="sec"> Retweets</span>
            </Text>
          </div>
        )}
      </div>
